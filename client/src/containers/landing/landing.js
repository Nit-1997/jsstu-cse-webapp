...
class Landing extends Component {
    ...
    if (this.props.loggedIn) {
      logoutBtn = (
        <Fragment style={{ display: "inline" }}>
          <li>
            <a href="#1" onClick={this.dashboard}>
              Dashboard
            </a>
          </li>
          <li>
            <a href="#2" onClick={this.logout}>
              Logout
            </a>
          </li>
        </Fragment>
      ...
      logoutBtn = (
        <Fragment style={{ display: "inline" }}>
          <li>
            <a href="#3" onClick={this.login}>
              Login
            </a>
          </li>
          <li>
            <a href="#4" onClick={this.signup}>
              Signup
            </a>
          </li>
        </Fragment>
                  ...
                  <div className="col-lg-8">
                    <div className="owl-carousel testimonials-carousel wow fadeInUp">
                      ...
                      <div className="testimonial-item">
                        ...
                        <p>
                          For more information:
                          <a href="https://en.wikipedia.org/wiki/Nidhi_Subbaiah">
                            "https://en.wikipedia.org/wiki/Akhilesh_Yadav"
                          </a>
                        </p>
                      </div>
  ...
  ============================--> */}
        ...
        --> */}
          ...
          <a href="#1" className="back-to-top">
